...
#include "pony/ShapeInferenceOpInterfaces.cpp.inc"
...
class ShapeInferencePass
    : public mlir::PassWrapper<ShapeInferencePass, OperationPass<pony::FuncOp>> {
public:
...
std::unique_ptr<mlir::Pass> mlir::pony::createShapeInferencePass() {
